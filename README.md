...
- **GitHub Workflow Detection**: Scans for suspicious GitHub workflow files (specifically `formatter_123456789.yml`) that may be part of supply chain attacks
...
🔧 Checking GitHub workflows in ./my-project
	💾 Results saved to results/checkGithubWorkflow-2024-01-01T12-00-00-000Z.json
	🟢 No suspicious workflow file 'formatter_123456789.yml' found.
...
🔧 Checking GitHub workflows in ./my-project
	💾 Results saved to results/checkGithubWorkflow-2024-01-01T12-00-00-000Z.json
	🚨 The suspicious workflow file 'formatter_123456789.yml' was found in 1 location(s).
...
7. **Scanning GitHub workflows** for suspicious workflow files that may be part of supply chain attacks
8. **Reporting matches** with detailed information about compromised files and packages
